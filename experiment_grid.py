...
from decision_transformer.models.decision_transformer_grid import DecisionTransformer
...
def experiment(
    ...
    state_dim = 1   # DUMMY Variable for grid
    ...
    def get_batch(batch_size=256, max_len=K):
        ...
        for i in range(batch_size):
            ...
            s.append(traj_obs.reshape(1, -1, 3, res, res))    # Grid
            ...
            tlen = s[-1].shape[1]
            ### CHANGED Reshape parameters for state
            s[-1] = np.concatenate([np.zeros((1, max_len - tlen, 3, res, res)), s[-1]], axis=1) # Grid
